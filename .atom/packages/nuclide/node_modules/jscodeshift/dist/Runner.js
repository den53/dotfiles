...
function showFileStats(fileStats) {
  console.log('Results:', clc.red(fileStats.error + ' errors'), clc.yellow(fileStats.nochange + ' unmodified'), clc.yellow(fileStats.skip + ' skipped'), clc.green(fileStats.ok + ' ok'));
}
